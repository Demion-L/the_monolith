...
export function compileMarkdownArtifact(input) {
    ...
    for (const heading of parsed.headings) {
        ...
        if (!label)
            continue;
        if (isStructuralHeadingNoise(label))
            continue;
        concepts.push({
...
export function isStructuralHeadingNoise(label) {
...
function looksLikeNamedConcept(text) {
