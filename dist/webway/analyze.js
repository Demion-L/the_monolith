...
const LINK_ROTATION = ['relates-to', 'extends', 'depends-on'];
...
export function analyzeArtifact(artifact) {
    ...
    const concepts = topWords.map(([label, count], idx) => ({
